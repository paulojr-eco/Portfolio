...
const AnimatedLogo = ({ t }: AnimatedLogoProps) => {
  ...
  return (
    <div className="fixed h-screen w-screen top-0 left-0 flex flex-col items-center justify-between bg-gradient-to-tr from-[#0E0F4B] to-[#361966] gap-y-6 cursor-progress z-[9999]">
